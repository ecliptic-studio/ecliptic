 ...
 */
export async function createGraphClientFx(portal: {fetch: typeof fetch, db: TKysely}, args: {mailboxOauth: Pick<ExternalMailboxOauth, 'id' | 'access_token' | 'expires_at' | 'refresh_token'>}): Promise<TErrTuple<GraphServiceClient>> {
